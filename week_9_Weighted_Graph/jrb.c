...
JRB make_jrb()// ham tao mot cay jrb moi
{
  JRB head;
...
JRB jrb_find_str(JRB n, char *key)// ham tim mot node qua gia tri kieu string
{
  int fnd;
  JRB j;
...
JRB jrb_find_int(JRB n, int ikey)// ham tim kiem mot node co gia tri kieu int
{
  int fnd;
  JRB j;
...
JRB jrb_find_dbl(JRB n, double dkey)// ham tim kiem mot node kieu double
{
  int fnd;
  JRB j;
...
JRB jrb_find_gen(JRB n, Jval key, int (*fxn)(Jval, Jval))// ham tim kiem mot node kieu ham
{
  int fnd;
  JRB j;
...
JRB jrb_insert_str(JRB tree, char *key, Jval val)// ham them mot node kieu char vao cay
{
  Jval k;
  int fnd;
...
JRB jrb_insert_int(JRB tree, int ikey, Jval val)// ham them mot node kieu int vao cay
{
  Jval k;
  int fnd;
...
JRB jrb_insert_dbl(JRB tree, double dkey, Jval val)// ham them mot node kieu double vao cay
{
  Jval k;
  int fnd;
...
// ham them mot node moi vao cay kieu truyen vao theo ham
