...
// dinh nghia cau truc du lieu hop(union) jval
typedef union {
    int i;
    long l;
    float f;
...
// cac ham khoi tao cac gia tri kieu jval
extern Jval new_jval_i(int);// ham chuyen tu kieu int sang kieu jval
...
// cac ham lay ra cac gia tri kieu int , long , float,... tu kieu jval
